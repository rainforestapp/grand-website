...
- Site footer: a top row (tagline + `hello@grandelderare.com` contact on the left, four nav links as a right-aligned single column) above a bottom bar with the `grand.` logo bottom-left and the copyright bottom-right.
