...
- Configured GitHub Pages for the canonical custom domain `grandeldercare.com`, with DNSimple records pointing the apex domain to GitHub Pages A/AAAA records and `www` to `fredsterss.github.io`. HTTPS is enforced for the apex domain.
